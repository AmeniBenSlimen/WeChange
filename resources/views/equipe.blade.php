...
<section id="home">
    ...
    <nav>
      ...
      <ul>
        ...
        <li><a href="">@lang('public.Equipe')</a></li>
...
<div class="container py-5">
    <div class="row text-center">
      <div class="col-lg-12">
        <h1>
        Notre Equipe We Change
       
       </h1>
        <p class="lead font-weight-normal mt-4" style="color: blue;margin-bottom: 3.5em;"></p>
      </div>
...
<img src="{{asset('images/'.$i->image)}}" class="card-img-top" alt="Jane">
        ...
        <path d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V0Z" class="shape-fill"></path>
              ...
              <div class="card-body">
                <blockquote>
                   ...
                   {{$i->description_membre}}
                    </p>
                  </blockquote>
                
              </div>
              <div class="card-footer">
                <p class="mb-0 font-weight-bolder" style="color:#ff2c95">{{$i->nom_membre}} {{$i->prenom_membre}}</p>
                <small class="text-muted">{{$i->specialite}}</small>
                <p class="mb-0 font-weight-bolder">{{$i->contact}}</p>
              </div>
