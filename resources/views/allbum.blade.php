...
@if(session()->get('success'))
  ...
  <div class="card-body">
    ...
    <div class="modernForm">
      ...
      <div class="name">
            <label for="titre_allbum" >Titre de l'allbum :</label>
            <input type="text"  name="nom_allbum"  placeholder="Titre de l'allbum" required/>
            <div class="iconName"><i class="fa-solid fa-user"></i></div>
          </div>
          <div class="name">
            <label for="description">Description de l'allbum :</label>
            <textarea type="text" class="form-control" name="description_allbum" placeholder="Description de l'allbum" required></textarea>
